        ...
        <div class="row justify-content-center d-flex mt-5">
            <div class="col-md-12">
                ...
                <div class="row mt-4">
                    <div class="col-md-4">
                        @if ($book->image !='')
                                    <img src="{{asset('upload/books/thumb/'.$book->image)}}" alt="" class="card-img-top">
                        @else
                                    <img src="https://placehold.co/990x1440?text=NoImage" alt="" class="card-img-top">
                         @endif
                    </div>
                    <div class="col-md-8">
                            ...
                            <div class="col-md-4 col-lg-4 mb-4">
                                ...
                                <a href="{{route("book.detail",$relatedBook-> id)}}">
                                    @if ($relatedBook->image !='')
                                        <img src="{{asset('upload/books/thumb/'.$relatedBook->image)}}" alt="" class="card-img-top">
                                    @else
                                        <img src="https://placehold.co/990x1440?text=NoImage" alt="" class="card-img-top">
                                    @endif
                                </a>
                    ...
                    <input type="hidden" name="book_id" value="{{ $book->id }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="review" id="review" class="form-control" cols="5" rows="5" placeholder="Review"></textarea>
                             <p class="invalid-fedback" id="review-error"></p>
                        </div>
                        <div class="mb-3">
